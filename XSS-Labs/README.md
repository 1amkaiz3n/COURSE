...
👉 Fokus utama: mengidentifikasi titik refleksi input, memahami konteks eksekusi, lalu memanfaatkan payload yang sesuai untuk memicu eksekusi `alert()` sebagai bukti keberhasilan exploit.
